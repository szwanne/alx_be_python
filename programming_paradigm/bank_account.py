...
class BankAccount:
    def __init__(self, account_balance=0):
        self.account_balance = round(float(account_balance), 0)
# Amount to be deposited into the bank

    def deposit(self, amount):
        self.account_balance += round(float(amount), 0)
        self.account_balance = round(float(amount), 0)
...
# Comparing the amount to be withdraw to the amount
    ...
    def withdraw(self, amount):
        ...
        if (self.account_balance >= amount):
            ...
            self.account_balance = round(self.account_balance, 0)
            return True
        else:
            return False
# The function will display the account balance
    ...
    def display_balance(self):
        return print(f"Current Balance: ${round((self.account_balance), 0)}")
